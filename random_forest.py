...
features_one = train_select[
    ['Name_bool', 'AgeuponOutcome_In_Days', 'year', 'hour', 'minute', 'quarter', 'weekofyear', 'Classement_2013',
     'Classement_2014', 'Classement_2015', 'Type_sex', 'SexuponOutcome_cat', 'AnimalType_cat']].values
...
test_features = test_select[
    ['Name_bool', 'AgeuponOutcome_In_Days', 'year', 'hour', 'minute', 'quarter', 'weekofyear', 'Classement_2013',
     'Classement_2014', 'Classement_2015', 'Type_sex', 'SexuponOutcome_cat', 'AnimalType_cat']].values

my_prediction = my_forest.predict(test_features)
ID = np.array(test_ID.values).astype(int)
my_solution = pd.DataFrame(my_prediction, ID, columns=["OutcomeType"])

# Write solution to a csv file
my_solution["Adoption"] = 0
my_solution["Adoption"][my_solution["OutcomeType"] == 2] = 1
my_solution["Died"] = 0
my_solution["Died"][my_solution["OutcomeType"] == 4] = 1
my_solution["Euthanasia"] = 0
my_solution["Euthanasia"][my_solution["OutcomeType"] == 1] = 1
my_solution["Return_to_owner"] = 0
my_solution["Return_to_owner"][my_solution["OutcomeType"] == 0] = 1
my_solution["Transfer"] = 0
my_solution["Transfer"][my_solution["OutcomeType"] == 3] = 1
